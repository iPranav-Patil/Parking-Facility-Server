...
public class Final extends JFrame implements ActionListener {
	...
	Final() {
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/saps_parking", "root",
					"Root@1234");
		...
		// String str = "insert into signup values('" + a1 + "','" + a2 + "','" + a3 +
		// "','" + a4 + "')";
		// Class.forName("com.mysql.jdbc.Driver");
		// Connection con =
		// DriverManager.getConnection("jdbc:mysql://localhost:3306/saps_parking",
		// "root",
		// "Root@1234");
		// Statement stmt1;
		...
		bi1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				f5.setVisible(true);
				tt = new Timer(dela, b -> {
					if (String.valueOf(b51.getBackground()).equals(redb)) {
						b51.setBackground(COLOR1);
						bf1.setBackground(COLOR1);
					}
					// if (b52s.equals(redb)) {
		...
		b73.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent j) {
				...
				tt.setInitialDelay(10000);
				tt.setCoalesce(rootPaneCheckingEnabled);
				tt.setRepeats(true);
				tt.restart();
